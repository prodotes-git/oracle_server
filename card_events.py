...
async def get_shinhan_cards(): return get_cached_data(SHINHAN_CACHE_KEY, 'shinhan_data.json')
@router.get("/api/kb-cards")
async def get_kb_cards(): return get_cached_data(KB_CACHE_KEY, 'kb_data.json')
@router.get("/api/hana-cards")
async def get_hana_cards(): return get_cached_data(HANA_CACHE_KEY, 'hana_data.json')
@router.get("/api/woori-cards")
async def get_woori_cards(): return get_cached_data(WOORI_CACHE_KEY, 'woori_data.json')
@router.get("/api/bc-cards")
async def get_bc_cards(): return get_cached_data(BC_CACHE_KEY, 'bc_data.json')
